                ...
                <div class="card-body pt-4 p-3">
                    <form action="{{ route('user-management.store') }}" method="POST" enctype="multipart/form-data"
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('name') is-invalid @enderror"
                                        value="{{ old('name') }}" type="text" placeholder="Juan Dela Cruz"
                                        id="" name="name">
                                    @error('name')
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control  @error('birthdate') is-invalid @enderror"
                                        value="{{ old('birthdate') }}" type="date" placeholder="juancruz@example.com"
                                        id="" name="birthdate">
                                    @error('birthdate')
                                        <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                    @enderror
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('email') is-invalid @enderror"
                                        value="{{ old('email') }}" type="email" placeholder="juancruz@example.com"
                                        id="" name="email">
                                    @error('email')
                                        <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                    @enderror
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('contact_no') is-invalid @enderror" type="text"
                                        placeholder="09123123122" id="number" name="contact_no" pattern="[0-9]{11}"
                            ...
                            <span class="text-muted small">Default Password for staffs: <strong>P@ssw0rd</strong> </span>
                        </div>
                        <div class="d-flex justify-content-end">
                            <button type="submit" class="btn bg-gradient-primary btn-md mt-4 mb-4">SAVE NEW STAFF</button>
                        </div>
                    </form>
                </div>
            </div>
