                            ...
                            <tr>
                                ...
                                <td class="align-middle text-center">
                                    <div class="align-middle">
                                        <a href="{{ route('returned-product.view', $prodPurInfo->id ) }}" class="btn bg-gradient-success btn-sm  me-1 mb-0 px-3">View</a>
                                        <a href="{{ route('returned-product.edit', $prodPurInfo->id ) }}" class="btn bg-gradient-info btn-sm  me-1 mb-0 px-3">Edit</a>
                                        @livewire('returned-prod.delete', ['prodPurInfo' => $prodPurInfo], key($prodPurInfo->id))
                                    </div>
                                </td>
                            </tr>
                            @empty
