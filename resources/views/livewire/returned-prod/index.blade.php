        ...
        <div class="card-header pb-0 d-flex justify-content-between align-items-center ">
            ...
            <div class="card-tool d-flex justify-content-end align-items-center align-middle">
                ...
                <a href="{{ route('returned-product.create') }}" class="btn btn-sm bg-gradient-info align-middle">
                    <span><i class="fa fa-plus me-1" aria-hidden="true"></i></span> Add Returned Product</a>
            </div>
        </div>
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle text-center">
                                        <div class="align-middle">
                                            <a href="{{ route('returned-product.view', $prodPurInfo->id) }}"
                                                class="btn bg-gradient-success btn-sm  me-1 mb-0 px-3">View</a>
                                            <a href="{{ route('returned-product.edit', $prodPurInfo->id) }}"
