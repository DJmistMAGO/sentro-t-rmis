                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" value="{{ $reference_no }}" name="reference_no" id=""
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="date" value="{{ old('date_preparation') ?? date('Y-m-d') }}"
                                    name="date_preparation" id="" class="form-control" placeholder="">
                            </div>
                        </div>
                    </div>
                </div>
